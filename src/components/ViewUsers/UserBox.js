                ...
                <Row>
                    <Col>
                        <div className="text-center mt-3">
                            ...
                            <h5 className="mt-2 mb-0">User 1</h5>
                        ...
                        <div className="mt-3 pt-2 border-top">
                            <h4 className="mb-3 font-size-15">Booking Information</h4>
                            <div className="table-responsive">
                                <table className="table table-borderless mb-0 text-muted">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">Last Booked Date</th>
                                            <td>27/5/2020</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Last Booked Place</th>
