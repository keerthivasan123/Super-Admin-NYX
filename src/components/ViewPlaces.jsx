          ...
          <Card>
            <CardBody className="p-0">
              <div className="d-flex justify-content-between border-bottom p-2">
                <h6 className="card-title p-3 mb-0 header-title">
                  Place Overview
                </h6>
                <div className="d-flex justify-content-end p-2">
                  ...
                  <Link to="/calender">
                    <button className="btn btn-soft-primary">Calender</button>
                  </Link>
                </div>
              </div>
              ...
              <Row className="py-1">
                ...
                <Col xl={3} sm={6}>
                  <Media className="p-3">
                    ...
                    <Media body>
                      <h4 className="mt-0 mb-0">Rs.5000000</h4>
                      <span className="text-muted font-size-13">
                        Total Revenue
                      </span>
                    </Media>
                ...
                <Col xl={3} sm={6}>
                  <Media className="p-3">
                    <CheckSquare className="align-self-center icon-dual icon-lg mr-4"></CheckSquare>
                    <Media body>
                      <h4 className="mt-0 mb-0">Rs.40000</h4>
                      <span className="text-muted font-size-13">
                ...
                <Col xl={3} sm={6}>
                  <Media className="p-3">
                    ...
                    <Media body>
                      <h4 className="mt-0 mb-0">12/04/2020</h4>
                      <span className="text-muted font-size-13">
                        Started Date
                      </span>
                    </Media>
